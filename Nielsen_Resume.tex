...
\begin{innerlist}
\item Lead the design of a library for complex feature creation and event detection in real-time IoT data streams.
\item Contributed to the development of a platform to store, manage, recall and re-evaluate the output from this library in a scalable cloud environment. 
