...
\item Expanding my machine learning knowledge to include Natural Language Processing techniques such as text summarization, POS tagging, and word embeddings.
...
\begin{outerlist}
\item[] \textit{Software Engineer} \hfill{Sept 2017 to present}
\begin{innerlist}
\item Consulting as Principal -- Data Engineering \& Data Science for \href{https://www.corelogic.com}{\textbf {CoreLogic}}.
\item Leading a team developing cutting-edge machine learning frameworks to implement predictive modeling as well as other domain-tailored ML tasks.
\item  Following agile software developing practices and developed primarily in {\sc Python, SQL, Apache Beam} and {\sc TensorFlow} on {\sc Google Cloud Platform (GCS, Dataflow, BigQuery, CloudML, Airflow)}.
\end{innerlist}
\end{outerlist}
\medbreak
