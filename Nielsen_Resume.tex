...
\begin{innerlist}
\item Lead the design a library for complex feature creation in real-time IoT data streams.
\item Contributed to the development of a platform to store, manage, recall and re-evaluate the output from this pattern recognition in a scalable cloud environment. 
